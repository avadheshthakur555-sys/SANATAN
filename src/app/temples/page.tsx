...
export default function TemplesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-[#F5F0E8] relative overflow-hidden flex flex-col items-center">
        ...
        <section ref={containerRef} className="w-full mb-12 bg-white/3 border border-[#D4AF37]/25 p-5 md:p-8 rounded-3xl backdrop-blur-md shadow-2xl relative">
          ...
          {loading ? (
            <div className="h-[500px] w-full flex flex-col items-center justify-center gap-4">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-[#B8860B]">Projecting Cosmic Map Coordinates...</span>
            </div>
          ) : (
            <AtlasInteractiveMap
              places={places}
